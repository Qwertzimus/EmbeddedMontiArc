package de.monticore.lang.embeddedmontiarc.tag;
...
import de.monticore.lang.embeddedmontiarc.tag.drawing.ConnectorLayoutSymbolCreator;
import de.monticore.lang.embeddedmontiarc.tag.drawing.TraceabilityTagSchema.IsTraceableSymbol;
import de.monticore.lang.embeddedmontiarc.tag.drawing.TraceabilityTagSchema.TraceabilityTagSchema;
import de.monticore.lang.embeddedmontiarc.tag.drawing.TraceabilityTagSchema.TraceableSymbol;
...
public class TagTest {
  ...
  public void testIsTraceable() throws Exception {
    ...
    ExpandedComponentInstanceSymbol cmp = symTab.<ExpandedComponentInstanceSymbol>resolve("industry.MainController", ExpandedComponentInstanceSymbol.KIND).orElse(null);
    assertNotNull(cmp);
    System.out.println(cmp);
    assertEquals(cmp.getTags(IsTraceableSymbol.KIND).size(), 1);

    cmp = symTab.<ExpandedComponentInstanceSymbol>resolve("industry.BrakeController", ExpandedComponentInstanceSymbol.KIND).orElse(null);
    assertNotNull(cmp);
    System.out.println(cmp);
    assertEquals(cmp.getTags(IsTraceableSymbol.KIND).size(), 1);

    cmp = symTab.<ExpandedComponentInstanceSymbol>resolve("industry.PitchRegulator", ExpandedComponentInstanceSymbol.KIND).orElse(null);
    assertNotNull(cmp);
    System.out.println(cmp);
    assertEquals(cmp.getTags(IsTraceableSymbol.KIND).size(), 1);

    cmp = symTab.<ExpandedComponentInstanceSymbol>resolve("industry.Filtering", ExpandedComponentInstanceSymbol.KIND).orElse(null);
    assertNotNull(cmp);
    System.out.println(cmp);
    assertEquals(cmp.getTags(IsTraceableSymbol.KIND).size(), 0);

    cmp = symTab.<ExpandedComponentInstanceSymbol>resolve("industry.ParkController", ExpandedComponentInstanceSymbol.KIND).orElse(null);
    assertNotNull(cmp);
    System.out.println(cmp);
    assertEquals(cmp.getTags(IsTraceableSymbol.KIND).size(), 0);
